...
int16_t g_offset_top     = 0;
int16_t g_offset_bottom  = 0;
int16_t g_offset_left    = 0;
int16_t g_offset_right   = 0;
    ...
    while (1) {
        ...
        switch (c) {
            ...
            case 'a':
                ...
                break;
            case 'T':
                g_offset_top = atoi(optarg);
                break;
            case 'B':
                g_offset_bottom = atoi(optarg);
                break;
            case 'L':
                g_offset_left = atoi(optarg);
                break;
            case 'R':
...
void *jpegd_send_stream_compatible(void *pArgs)
{
    ...
    while (1) {
        ...
        while ((dirp = readdir(currentDir)) != nullptr) {
            ...
            outPicInfo.offset_top    = g_offset_top;
            outPicInfo.offset_bottom = g_offset_bottom;
            outPicInfo.offset_left   = g_offset_left;
            outPicInfo.offset_right  = g_offset_right;
