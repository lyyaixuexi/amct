...
[dvpp_pngd_1920x1080_RGBA.png](https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/data/dvpp_sample_input_data/dvpp_pngd_1920x1080_RGBA.png)
...
1. 以运行用户登录编译环境，编译代码。
   1. aarch64编译环境的编译方法
        1. 设置环境变量。
            ...
            ```
        2. 切换到pngd\_sample目录，依次执行如下命令执行编译。
            ...
            make
            ```
            在“pngd\_sample/build/“目录下会生成可执行程序pngd\_demo。
   ...
   2. x86_64编译环境的编译方法
        ...
        2. 设置环境变量。
            ...
            ```
        3. 切换到pngd\_sample目录，依次执行如下命令执行编译。
