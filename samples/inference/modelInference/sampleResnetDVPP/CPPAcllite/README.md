...
## 样例运行
  ...
  - 数据准备
    ...
    ```    
    cd $HOME/samples/inference/modelInference/sampleResnetDVPP/CPPAcllite/data
  ...
  - ATC模型转换
    ...
    cd $HOME/samples/inference/modelInference/sampleResnetDVPP/CPPAcllite/model
  ...
  - 样例编译
    ...
    ```
    cd $HOME/samples/inference/modelInference/sampleResnetDVPP/CPPAcllite/scripts
  ...
  - 样例结果展示
    ...
    [INFO]  top 1: index[162] value[0.945116] class[beagle]
    [INFO]  top 2: index[161] value[0.047055] class[bassetbasset hound]
    [INFO]  top 3: index[167] value[0.003893] class[English foxhound]
    [INFO]  top 4: index[166] value[0.003462] class[Walker houndWalker foxhound]
    [INFO]  top 5: index[163] value[0.000189] class[bloodhound sleuthhound]
...
## 更新说明
  | 时间 | 更新事项 |
|----|------|
| 2023/02/17 | 新增sampleResnetDVPP/CPPAcllite/README.md |
