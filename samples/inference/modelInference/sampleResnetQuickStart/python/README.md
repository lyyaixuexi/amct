...
## 样例运行
  ...
  - 样例结果展示
    ...
    label:162 confidence:0.902207 class:beaglebeagle,	
    label:161 confidence:0.096589 class:basset houndbasset hound,	
    label:166 confidence:0.000621 class:Walker foxhoundWalker foxhound,	
    label:167 confidence:0.000444 class:English foxhoundEnglish foxhound,	
    label:163 confidence:0.000055 class:sleuthhoundsleuthhound,	
    *****run finish******
    ```
...
## 更新说明
  | 时间 | 更新事项 |
|----|------|
| 2023/02/17 | 新增sampleResnetQuickStart/python/README.md |
