...
evaluator = amct.ModelEvaluator(
    data_dir="./data/imagenet_train/", 
    input_shape="input:1,3,224,224", 
    data_types="float32")

model = torchvision.models.resnet101(pretrained=False)
model.load_state_dict(torch.load("/mnt/cephfs/home/chenzhuokun/git/ascend_project/models/resnet/resnet101-5d3b4d8f.pth"))
input_data = tuple([torch.randn((1,3,224,224))])
amc_config = './amc.cfg'
save_dir = 'output_mix/output_mix'
