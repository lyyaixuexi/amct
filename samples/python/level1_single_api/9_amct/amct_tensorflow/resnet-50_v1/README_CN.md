...
+ [record.txt](./outputs/nuq/record.txt): 量化因子记录文件，记录量化因子。
...
+ [record.txt](./outputs/retrain/record.txt): 量化因子记录文件，记录量化因子。
+ [resnet_v1_50_origin.pb](./outputs/retrain/resnet_v1_50_origin.pb): 原始推理模型。
...
+ [checkpoint](./outputs/retrain/checkpoint): 训练检查点。
+ [events.out.tfevents.xxxxxxxxxx.xxx](./outputs/retrain/events.out.tfevents.xxxxxxxxxx.xxx): 训练记录，包含重训练时的 loss 信息，可使用 TensorBoard 查看。
+ [record.txt](./outputs/retrain/record.txt): 稀疏记录文件，记录可稀疏结点间的级联关系。
+ [resnet_v1_50.pb](./outputs/retrain/resnet_v1_50_masked.pb): 插入mask算子的模型，通道稀疏过程的中间文件。
+ [resnet_v1_50_quantized.pb](./outputs/retrain/resnet_v1_50_quantized.pb): 稀疏模型，可在 TensorFlow 环境进行精度仿真并可在昇腾 AI 处理器部署。
+ [resnet_v1_50_retrain-0.data-00000-of-00001](./outputs/retrain/resnet_v1_50_retrain-0.data-00000-of-00001)
+ [resnet_v1_50_retrain-0.index](./outputs/retrain/resnet_v1_50_retrain-0.index)
+ [resnet_v1_50_retrain-0.meta](./outputs/retrain/resnet_v1_50_retrain-0.meta)
+ [resnet_v1_50_retrain-100.data-00000-of-00001](./outputs/retrain/resnet_v1_50_retrain-1.data-00000-of-00001)
...
组合压缩成功后，在当前目录会生成量化日志文件 [./amct_log/amct_tensorflow.log](./amct_log/amct_tensorflow.log) 和 [./outputs/retrain](./outputs/retrain/) 文件夹，该文件夹内包含以下内容：

+ [checkpoint](./outputs/retrain/checkpoint): 训练检查点。
+ [events.out.tfevents.xxxxxxxxxx.xxx](./outputs/retrain/events.out.tfevents.xxxxxxxxxx.xxx): 训练记录，包含重训练时的 loss 信息，可使用 TensorBoard 查看。
+ [record.txt](./outputs/retrain/record.txt): 量化因子记录文件，记录量化因子及稀疏记录。
+ [resnet_v1_50.pb](./outputs/retrain/resnet_v1_50.pb): 插入量化及稀疏算子的推理模型。
+ [resnet_v1_50_comp_quantized.pb](./outputs/retrain/resnet_v1_50_comp_quantized.pb): 组合压缩模型，可在 TensorFlow 环境进行精度仿真并可在昇腾 AI 处理器部署。
+ [resnet_v1_50_retrain-0.data-00000-of-00001](./outputs/retrain/resnet_v1_50_retrain-0.data-00000-of-00001)
+ [resnet_v1_50_retrain-0.index](./outputs/retrain/resnet_v1_50_retrain-0.index)
+ [resnet_v1_50_retrain-0.meta](./outputs/retrain/resnet_v1_50_retrain-0.meta)
+ [resnet_v1_50_retrain-100.data-00000-of-00001](./outputs/retrain/resnet_v1_50_retrain-1.data-00000-of-00001)
...
自动稀疏成功后，在当前目录会生成日志文件 [./amct_log/amct_tensorflow.log](./amct_log/amct_tensorflow.log) 和 [./outputs/retrain](./outputs/retrain/) 文件夹，该文件夹内包含以下内容：
...
+ [resnet_v1_50_retrain-100.index](./outputs/retrain/resnet_v1_50_retrain-1.index)
+ [resnet_v1_50_retrain-100.meta](./outputs/retrain/resnet_v1_50_retrain-1.meta)
+ [prune_cfg.cfg](./outputs/retrain/prune_cfg.cfg): 自动通道稀疏搜索输出的稀疏配置文件。
